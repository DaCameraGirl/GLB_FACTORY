...
This project is maintained by [Angela Hudson (@DaCameraGirl)](https://github.com/DaCameraGirl).
...
### Angela Hudson
- Core procedural avatar generation system
- Creature variants and mesh styles
- Mutation lab and chaos generation
- Snapchat lens effects
- Web Audio soundboard
- All original architecture and design
